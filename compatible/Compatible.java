...
public class Compatible implements Serializable {
    ...
    public List<Integer> _list = new ArrayList<Integer>();
    ...
    {
        return (1 == input) ? "#ff6060" : "#808080";
    }

    public String getCompatibleColor(boolean input)
    {
        return (true == input) ? "#ff6060" : "#808080";
    }
